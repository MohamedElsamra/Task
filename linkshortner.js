...
const ItemCtrl = (function(){
    ...
    const data = {
        items: [
            {id:0, url:'https://www.frontendmentor.io', shortUrl:'https://re.link/k4lKyk'},
            {id:1, url:'https://www.twitter.com/frontendmentor', shortUrl:'https://re.link/gxOXp9'},
            {id:2, url:'https://www.linkedin.com/company/frontend-mentor', shortUrl:'https://re.link/gob3X9'}
        ],
        currentItem: null
    };
    ...
    return{
        ...
        generateLink: function(){
            ...
            return 'https://app.shrtco.de/'+c1+c2+c3+c4;
        },
